	...
	def upgradebuilding(self,castleid,positionid,buildingtype=-1,currentlevel=0,tried=0):
		...
		try:
			...
			if ((e.args[0]==-45)|(e.args[0]==-8)):
				...
				return
			raise e
	def destructbuilding(self,castleid,positionid):
		self.city.client.sendmessage('castle.destructBuilding',{"castleId":castleid,"positionId":positionid})
		res=self.city.responsehandler("castle.destructBuilding")
